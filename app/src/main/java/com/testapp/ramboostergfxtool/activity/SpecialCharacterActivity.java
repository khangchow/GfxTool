...
public class SpecialCharacterActivity extends AppCompatActivity implements SpecialKeyboardItemClick.KeyboardItemClick {
    ...
    public void onCreate(Bundle bundle) {
        ...
        this.toolbar.setTitle(getString(R.string.nickname_generator));
    ...
    class MyItemClick implements SpecialAdapter.SpecialTextItemClick {
        ...
        public void copyClick(String str) {
            ...
            InterstitialAdShow.getInstance(SpecialCharacterActivity.this).showInterstitialAd(SpecialCharacterActivity.this, new  InterstitialAdShow.AdCloseListener() {
                @Override
